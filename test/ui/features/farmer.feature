...
Scenario: Loading the first level
  Then there's an image "video_thumbnails/3.jpg"
  Then there's an image "farmer/small_static_avatar.png"
  Then I see "#pegman"
  Then there's 1 dirt at (4, 4)

Scenario: Winning the first level
  When I drag block "1" to offset "300, 200"
  And I drag block "1" to offset "400, 200"
  And I drag block "1" to offset "500, 200"
  And I drag block "4" to offset "400, 200"
  And I drag block "6" to block "5"
  And I drag block "7" to block "6"
  And I drag block "8" to block "7"
  And I drag block "9" to block "8"
