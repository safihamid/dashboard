...
namespace :deploy do
  ...
  task :post_deploy do
    ...
    run "tar -xvf #{release_path}/public/blockly/blockly-mooc.tgz && mv /home/#{user}/package/* #{release_path}/public/blockly/"
    run "#{release_path}/public/blockly/blockly-mooc.tgz"
